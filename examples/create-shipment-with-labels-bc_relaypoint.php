...
$request->labelType->type = $type = EPrint\Enum\ELabelType::PNG;
...
$request->services->parcelshop->shopaddress->shopid = 'P64240'; // See get-pudo-list.php

// Contact (required with relay point)
